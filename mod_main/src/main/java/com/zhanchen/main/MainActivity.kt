...
import com.zhanchen.main.databinding.ActivityMainBinding
import com.zhanchen.main.navigator.SumFragmentNavigator
...
//        )
        ...
        DialogUtils.showDialogWithInput(
            this,
            "请输入密码确认",
            object : DialogUtils.CustomInputListener {
                override fun onCustomInputConfirmed(inputText: String) {
                    if (inputText == "222555") {
                        ...
                        TipsToast.showWarningTips("密码错误，请重试")
                    }
                }
